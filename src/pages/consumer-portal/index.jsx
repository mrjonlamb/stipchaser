...
const ConsumerPortal = () => {
  ...
  useEffect(() => {
    ...
    },
    {
      ...
      feedback: "The address on the utility bill doesn't match the application. Please provide a bill with the correct address or update your application.",
      uploadedFile: {
    ...
    const mockMessages = [
    {
      ...
      content: "Hi Michael! I've received your pay stubs and they look great. Just waiting on a few more documents to complete your file.",
    ...
    },
    {
      id: 2,
      sender: "You",
      content: "Thanks Sarah! I just uploaded my bank statements. Let me know if you need anything else.",
    ...
    },
    {
      id: 4,
      sender: "Sarah Johnson",
      content: "Once we have the corrected utility bill and your driver's license, we should be able to move forward quickly with your approval!",
  ...
  const unreadMessages = messages?.filter((msg) => !msg?.isRead && msg?.sender !== 'You')?.length;
  const estimatedDays = Math.max(1, 7 - Math.floor(completedDocuments / totalDocuments * 6));
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Document Portal</h1>
              <p className="text-muted-foreground mt-2">
                Submit your required documents to complete your vehicle financing
              </p>
            </div>
            <Button
              variant="outline"
              onClick={() => navigate('/conversation-interface')}
            ...
            <div className="bg-warning/10 border border-warning/20 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-semibold text-warning mb-2">Action Required</h3>
                  <div className="space-y-1">
                    {notifications?.filter((n) => !n?.isRead)?.map((notification) =>
                  <p key={notification?.id} className="text-sm text-warning/80">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{dealerInfo?.phone}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{dealerInfo?.email}</p>
                  </div>
                </div>
                <div className="pt-2">
                  <Button
