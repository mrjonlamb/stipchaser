...
const ConversationInterface = () => {
  ...
  const conversations = [
    {
      ...
      customerAvatarAlt:
        "Professional headshot of woman with shoulder-length brown hair in white blazer",
    ...
    },
    {
      ...
      customerAvatar:
        "https://images.unsplash.com/photo-1724128195747-dd25cba7860f",
      customerAvatarAlt:
      ...
      lastMessage: {
        content:
          "Thanks for the quick response! I'll get those documents to you by tomorrow.",
    ...
    },
    {
      ...
      customerAvatar:
        "https://images.unsplash.com/photo-1585066047759-3438c34cf676",
      customerAvatarAlt:
        "Professional headshot of Caucasian man with beard wearing dark suit",
      ...
      lastMessage: {
        content:
          "I'm having trouble with the document upload. Can someone help?",
  ...
  const mockMessages = [
    {
      ...
      avatarAlt:
        "Professional headshot of woman with shoulder-length brown hair in white blazer",
      content:
        "Hi! I'm ready to submit my documents for the car loan. What do I need to provide?",
      timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
      channel: "chat",
      status: "read",
    },
    ...
    },
    {
      ...
      avatarAlt:
        "Professional headshot of woman with shoulder-length brown hair in white blazer",
      content:
        "Perfect! I have most of these ready. Let me start with my pay stub.",
    ...
    },
    {
      ...
      sender: "You",
      content:
        "Thank you! I've received your pay stub and it looks good. The amount and employer information are clear. Next, could you please upload your bank statements from the last 3 months?",
  ...
  const handleRequestDocument = (template) => {
    const requestMessage = {
      id: messages?.length + 1,
      sender: "You",
      content: `Hi! Could you please upload your ${template?.name?.toLowerCase()}? ${
